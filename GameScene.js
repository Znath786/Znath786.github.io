class GameScene extends Phaser.Scene {
    ...
    preload() {
        // load resources 
        this.load.image('background', 'assets/background5.jpg');
        this.load.image('platform', 'assets/groundPieces.png');
        this.load.image('platformSmall', 'assets/groundSmallPiece.png');
        this.load.image('character', 'assets/character.png');
        this.load.image('monster', 'assets/monsterNew.png');
        this.load.image('berry', 'assets/strawberry.png');
        this.load.image('ground', 'assets/realGround.png');
        this.load.image('newGame', 'assets/bigNewGame2.png');
