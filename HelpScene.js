class HelpScene extends Phaser.Scene {
	...
	preload(){
        this.load.image('backgroundHelp', 'assets2/background5.jpg');
        this.load.image('groundHelp', 'assets2/realGround.png');
        this.load.image('platformHelp', 'assets2/groundPieces.png');
        this.load.image('platformSmallHelp', 'assets2/groundSmallPiece.png');
        this.load.image('helpHelp', 'assets2/woodHelpMenu.png');  
    };
