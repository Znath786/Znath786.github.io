class QuitScene extends Phaser.Scene {
	...
	preload(){
        this.load.image('backgroundQuit', 'assets2/background5.jpg');
        this.load.image('groundQuit', 'assets2/realGround.png');
        this.load.image('platformQuit', 'assets2/groundPieces.png');
        this.load.image('platformSmallQuit', 'assets2/groundSmallPiece.png');
        this.load.image('quitMenu', 'assets2/quitMenu.png');
    };
