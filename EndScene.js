class EndScene extends Phaser.Scene {
	...
	preload(){
        this.load.image('backgroundEnd', 'assets/background5.jpg');
        this.load.image('groundEnd', 'assets/realGround.png');
        this.load.image('over', 'assets/gameOver.png');
        this.load.image('endNew', 'assets/endNewGame.png'); 
        this.load.image('platformEnd', 'assets/groundPieces.png');
        this.load.image('platformSmallEnd', 'assets/groundSmallPiece.png');
        this.load.image('monsterEnd', 'assets/monsterNew.png');
